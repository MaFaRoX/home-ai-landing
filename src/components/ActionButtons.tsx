          ...
          if (button.href) {
            return (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className={`${button.color} ${button.lightColor} ${button.borderColor} ${button.shadowColor} text-white dark:text-black py-3 px-6 rounded-xl border-2 shadow-lg transition-all uppercase tracking-wide relative overflow-hidden block text-center`}
              >
                {buttonContent}
              </motion.a>
            );
